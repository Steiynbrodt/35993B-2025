...
motor driveMotorLeftOne = motor(PORT6, ratio18_1, false);  
motor driveMotorLeftTwo = motor(PORT1, ratio18_1, false); 
motor driveMotorLeftThree = motor(PORT4, ratio18_1, false);


motor driveMotorRightOne = motor(PORT8, ratio18_1, true); 
...
motor in2 = motor(PORT11 ,ratio18_1, false); 
motor in3 = motor(PORT5, ratio18_1, false); 
